...
| P0_04 | 八阶段问答和影响分析 | M2 | `docs/specs/m2/controlled-conversation.md` | 八阶段 E2E、恢复、impact/confirm、409/422 |
...
| P0_07 | 气象 Provider、进度和 CSV | M4 | `docs/specs/m4/weather-ingestion.md` | Provider 失败转 CSV、连续性、UTC、进度/重试 |
...
| P0_14 | 单元/契约/E2E/主题/空库验收 | M6 | `docs/specs/m6/release-acceptance.md` | PRD 六剧本、治理/测试/部署证据、M0-M5 回归 |
